...
function ErrorPage({error,reset}: ErrorPageProps) {
  return (
    <div className="h-[100vh] flex flex-col gap-5 pt-3 items-center">
      <h1 className="text-3xl text-red-600">Some Thing Error</h1>
      <h3 className="text-xl font-extrabold">Error Typing: <span className="text-red-600">{error.message}</span> </h3>
