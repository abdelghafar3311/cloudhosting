...
function WebHostingPlan() {
  return (
    <div className='flex flex-col justify-center items-center w-3/4 rounded p-4 bg-gray-200 mb-7 md:w-2/4 lg:w-1/4'>
      ...
      <button className='mt-4 border-2 border-gray-900 text-gray-900 text-xl font-bold p-1 rounded-full hover:text-white hover:bg-gray-900 transition w-full'>BUY NOW</button>
    </div>
  )
}
